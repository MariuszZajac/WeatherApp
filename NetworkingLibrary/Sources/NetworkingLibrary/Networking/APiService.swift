...
protocol WeatherAPIServiceProtocol {
    associatedtype WeatherDataType
    func downloadWeatherData(latitude: Double, longitude: Double) async throws -> WeatherDataType
}


final class WeatherAPIService: WeatherAPIServiceProtocol {
    typealias WeatherDataType = WeatherData
