...
extension DailyWeather {
    static func make(dt: TimeInterval = 1696496400, sunrise: TimeInterval = 23872676188, sunset: TimeInterval = 2726847612, moonrise: TimeInterval = 23826847612, moonset: TimeInterval = 23872847612, moonPhase: Double = 0.2, summary: String = "something", temp: Temperature, feelsLike: Temperature , pressure: Int = 999, humidity: Int = 33, dewPoint: Double = 22.3, windSpeed: Double = 33.2, windDeg: Int = 33, windGust: Double = 33.2, weather: WeatherInfo, clouds: Int = 22, pop: Double = 3.4, uvi: Double = 2, visibility: Int = 222) -> Self {
